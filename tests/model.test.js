...
const shower=m.normalizeTask({id:'task-days-personal-take-a-shower',schedule:{type:'days',days:[1]},visibility:'visible'});assert.equal(shower.visibility,'private');assert.deepStrictEqual([...shower.defaultAssignedIds],[]);
